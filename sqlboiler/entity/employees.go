...
var EmployeeWhere = struct {
	...
	Gender:    whereHelperstring{field: "`employees`.`gender`"},
...
var (
	employeeAllColumns            = []string{"emp_no", "birth_date", "first_name", "last_name", "gender", "hire_date", "created_at", "updated_at", "deleted_at"}
	employeeColumnsWithoutDefault = []string{"emp_no", "birth_date", "first_name", "last_name", "gender", "hire_date", "created_at", "updated_at", "deleted_at"}
...
func (q employeeQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Employee, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for employees")
	}
...
func (q employeeQuery) All(ctx context.Context, exec boil.ContextExecutor) (EmployeeSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entity: failed to assign all query results to Employee slice")
	}
...
func (q employeeQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count employees rows")
	}
...
func (q employeeQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if employees exists")
	}
...
func Employees(mods ...qm.QueryMod) employeeQuery {
	mods = append(mods, qm.From("`employees`"), qmhelper.WhereIsNull("`employees`.`deleted_at`"))
	q := NewQuery(mods...)
...
func FindEmployee(ctx context.Context, exec boil.ContextExecutor, empNo int, selectCols ...string) (*Employee, error) {
	...
	query := fmt.Sprintf(
		"select %s from `employees` where `emp_no`=? and `deleted_at` is null", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: unable to select from employees")
	}
...
func (o *Employee) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no employees provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to insert into employees")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to populate default values for employees")
	}
...
func (o *Employee) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entity: unable to update employees, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update employees row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by update for employees")
	}
...
func (q employeeQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all for employees")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected for employees")
	}
...
func (o EmployeeSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all in employee slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected all in update all employee")
	}
	return rowsAff, nil
}
...
func (o *Employee) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no employees provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("entity: unable to upsert employees, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert for employees")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to retrieve unique values for employees")
	}
...
func (o *Employee) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if o == nil {
		return 0, errors.New("entity: no Employee provided for delete")
	}
	...
	if hardDelete {
		...
		sql = fmt.Sprintf("UPDATE `employees` SET %s WHERE `emp_no`=?",
			strmangle.SetParamNames("`", "`", 0, wl),
		)
		valueMapping, err := queries.BindMapping(employeeType, employeeMapping, append(wl, employeePrimaryKeyColumns...))
		if err != nil {
			return 0, err
		}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete from employees")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by delete for employees")
	}
...
func (q employeeQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entity: no employeeQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from employees")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by deleteall for employees")
	}
...
func (o EmployeeSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE `employees` SET %s WHERE "+
			strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, employeePrimaryKeyColumns, len(o)),
			strmangle.SetParamNames("`", "`", 0, wl),
		)
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from employee slice")
	}
...
func (o *EmployeeSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to reload all in EmployeeSlice")
	}
...
func EmployeeExists(ctx context.Context, exec boil.ContextExecutor, empNo int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from `employees` where `emp_no`=? and `deleted_at` is null limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entity: unable to check if employees exists")
	}

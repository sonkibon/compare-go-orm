...
func testEmployeesSoftDelete(t *testing.T) {
	t.Parallel()
...
func testEmployeesQuerySoftDeleteAll(t *testing.T) {
	t.Parallel()
	...
	if rowsAff, err := Employees().DeleteAll(ctx, tx, false); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testEmployeesSliceSoftDeleteAll(t *testing.T) {
	t.Parallel()
...
func testEmployeesQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := Employees().DeleteAll(ctx, tx, true); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testEmployeesExists(t *testing.T) {
	...
	e, err := EmployeeExists(ctx, tx, o.EmpNo)
	if err != nil {
...
func testEmployeesFind(t *testing.T) {
	...
	employeeFound, err := FindEmployee(ctx, tx, o.EmpNo)
	if err != nil {
		t.Error(err)
	}
...
func testEmployeeToManyEmpNoDeptEmps(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	check, err := a.EmpNoDeptEmps().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	if err = a.L.LoadEmpNoDeptEmps(ctx, tx, false, (*[]*Employee)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.EmpNoDeptEmps); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.EmpNoDeptEmps = nil
	if err = a.L.LoadEmpNoDeptEmps(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.EmpNoDeptEmps); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testEmployeeToManyEmpNoDeptManagers(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	check, err := a.EmpNoDeptManagers().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := EmployeeSlice{&a}
	if err = a.L.LoadEmpNoDeptManagers(ctx, tx, false, (*[]*Employee)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.EmpNoDeptManagers); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.EmpNoDeptManagers = nil
	if err = a.L.LoadEmpNoDeptManagers(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.EmpNoDeptManagers); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testEmployeeToManyEmpNoSalaries(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = randomize.Struct(seed, &b, salaryDBTypes, false, salaryColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &c, salaryDBTypes, false, salaryColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	...
	check, err := a.EmpNoSalaries().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := EmployeeSlice{&a}
	if err = a.L.LoadEmpNoSalaries(ctx, tx, false, (*[]*Employee)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.EmpNoSalaries); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.EmpNoSalaries = nil
	if err = a.L.LoadEmpNoSalaries(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.EmpNoSalaries); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testEmployeeToManyEmpNoTitles(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = randomize.Struct(seed, &b, titleDBTypes, false, titleColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &c, titleDBTypes, false, titleColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	...
	check, err := a.EmpNoTitles().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := EmployeeSlice{&a}
	if err = a.L.LoadEmpNoTitles(ctx, tx, false, (*[]*Employee)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.EmpNoTitles); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.EmpNoTitles = nil
	if err = a.L.LoadEmpNoTitles(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.EmpNoTitles); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testEmployeeToManyAddOpEmpNoDeptEmps(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddEmpNoDeptEmps(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.EmpNo != first.EmpNo {
			t.Error("foreign key was wrong value", a.EmpNo, first.EmpNo)
		}
		if a.EmpNo != second.EmpNo {
			t.Error("foreign key was wrong value", a.EmpNo, second.EmpNo)
		}

		if first.R.EmpNoEmployee != &a {
			t.Error("relationship was not added properly to the foreign slice")
		}
		if second.R.EmpNoEmployee != &a {
			t.Error("relationship was not added properly to the foreign slice")
		}

		if a.R.EmpNoDeptEmps[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.EmpNoDeptEmps[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.EmpNoDeptEmps().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
...
func testEmployeeToManyAddOpEmpNoDeptManagers(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddEmpNoDeptManagers(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.EmpNoDeptManagers[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.EmpNoDeptManagers[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.EmpNoDeptManagers().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testEmployeeToManyAddOpEmpNoSalaries(t *testing.T) {
	var err error
	...
	foreigners := []*Salary{&b, &c, &d, &e}
	for _, x := range foreigners {
		if err = randomize.Struct(seed, x, salaryDBTypes, false, strmangle.SetComplement(salaryPrimaryKeyColumns, salaryColumnsWithoutDefault)...); err != nil {
			t.Fatal(err)
		}
	}
	...
	foreignersSplitByInsertion := [][]*Salary{
		{&b, &c},
		{&d, &e},
	}

	for i, x := range foreignersSplitByInsertion {
		err = a.AddEmpNoSalaries(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.EmpNoSalaries[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.EmpNoSalaries[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.EmpNoSalaries().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testEmployeeToManyAddOpEmpNoTitles(t *testing.T) {
	var err error
	...
	foreigners := []*Title{&b, &c, &d, &e}
	for _, x := range foreigners {
		if err = randomize.Struct(seed, x, titleDBTypes, false, strmangle.SetComplement(titlePrimaryKeyColumns, titleColumnsWithoutDefault)...); err != nil {
			t.Fatal(err)
		}
	}
	...
	foreignersSplitByInsertion := [][]*Title{
		{&b, &c},
		{&d, &e},
	}

	for i, x := range foreignersSplitByInsertion {
		err = a.AddEmpNoTitles(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.EmpNoTitles[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.EmpNoTitles[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.EmpNoTitles().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
var (
	employeeDBTypes = map[string]string{`EmpNo`: `int`, `BirthDate`: `date`, `FirstName`: `varchar`, `LastName`: `varchar`, `Gender`: `enum('M','F')`, `HireDate`: `date`, `CreatedAt`: `datetime`, `UpdatedAt`: `datetime`, `DeletedAt`: `datetime`}
	_               = bytes.MinRead
)
